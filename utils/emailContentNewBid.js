const emailContentNewBid = (buyer, productName, bidPrice, datetime) => {
  return ` 
  <!DOCTYPE html>
                ...
                <table id="second-table" role="presentation" style="background-color: #ffffff;">
                    <tr>
                        <td style=" padding: 30px">
                            <table id="top-table" role="presentation" style="margin: 0 0 35px 0;">
                                <tr>
                                    <td align="left">
                    ...
                    color: rgba(49, 53, 59, 0.68);">Buyer</p>
                                    </td>
                                    <td align="right">
                                        <p style="font-size: 12px;
...
module.exports = emailContentNewBid;
